    ...
    <cxl-app-layout id="container">
      <cxl-marketing-nav slot="header">
        ...
        >
          ...
          <vaadin-tab theme="cxl-marketing-nav" id="menu-item-1820277" class="menu-item-split-nav menu-item-wide menu-item-search menu-item menu-item-type-custom menu-item-object-custom menu-item-1820277 menu-item-depth-0" aria-selected="false" role="tab" orientation="horizontal" tabindex="0">
      ...
      <section id="sensei_course_progress-2" class="widget-odd widget-last widget-first widget-1 widget widget_sensei_course_progress" slot="sidebar">
        ...
        <article class="entry author-susie has-excerpt post-3686 lesson type-lesson status-publish post course membership-content access-granted " itemscope="itemscope" itemtype="http://schema.org/CreativeWork" id="post-3686">
          <header class="entry-header">
            <h4 class="entry-title no-anchor" itemprop="headline">
              <iron-icon class="iron-icon" icon="lumo:angle-right"></iron-icon>
              <a href="https://conversionxli.warmpress.com/lesson/2-persuasion-psychology-brief-introduction/" rel="bookmark" itemprop="url"><span data-post-status="publish"></span>Persuasion Psychology: A Brief Introduction</a></h4>        </header><!-- .entry-header -->
        </article><!-- .entry -->
        ...
        <article class="entry author-susie has-excerpt post-3695 lesson type-lesson status-publish has-post-thumbnail post course membership-content access-granted " itemscope="itemscope" itemtype="http://schema.org/CreativeWork" id="post-3695">
          <header class="entry-header">
            <h4 class="entry-title no-anchor" itemprop="headline">
              <iron-icon class="iron-icon" icon="lumo:angle-right"></iron-icon>
              <a href="https://conversionxli.warmpress.com/lesson/4-gravity/" rel="bookmark" itemprop="url"><span data-post-status="publish"></span>Gravity</a></h4>        </header><!-- .entry-header -->
        </article><!-- .entry -->
        ...
        <article class="entry author-susie post-3706 lesson type-lesson status-publish post course lesson-completed membership-content access-granted user-status-completed" itemscope="itemscope" itemtype="http://schema.org/CreativeWork" id="post-3706">
          <header class="entry-header">
            <h4 class="entry-title no-anchor" itemprop="headline">
              <iron-icon class="iron-icon" icon="vaadin:check-circle"></iron-icon>
              <a href="https://conversionxli.warmpress.com/lesson/6-angle-conscious-motivation/" rel="bookmark" itemprop="url"><span data-post-status="publish"></span>The Angle: Conscious Motivation</a></h4>        </header><!-- .entry-header -->
        </article><!-- .entry -->


        <article class="entry author-susie post-3717 lesson type-lesson status-publish post course lesson-completed membership-content access-granted user-status-completed" itemscope="itemscope" itemtype="http://schema.org/CreativeWork" id="post-3717">
          <header class="entry-header">
            <h4 class="entry-title no-anchor" itemprop="headline">
              <iron-icon class="iron-icon" icon="vaadin:check-circle"></iron-icon>
              <a href="https://conversionxli.warmpress.com/lesson/7-angle-unconscious-motivation/" rel="bookmark" itemprop="url"><span data-post-status="publish"></span>The Angle: Non-Conscious Motivation</a></h4>        </header><!-- .entry-header -->
        </article><!-- .entry -->


        <article class="entry author-susie post-3719 lesson type-lesson status-publish post course lesson-completed membership-content access-granted user-status-completed" itemscope="itemscope" itemtype="http://schema.org/CreativeWork" id="post-3719">
          <header class="entry-header">
            <h4 class="entry-title no-anchor" itemprop="headline">
              <iron-icon class="iron-icon" icon="vaadin:check-circle"></iron-icon>
              <a href="https://conversionxli.warmpress.com/lesson/8-friction-real-difficulty/" rel="bookmark" itemprop="url"><span data-post-status="publish"></span>Friction: Real Difficulty</a></h4>        </header><!-- .entry-header -->
        </article><!-- .entry -->


        <article class="entry author-susie post-3721 lesson type-lesson status-publish post course lesson-completed membership-content access-granted user-status-completed" itemscope="itemscope" itemtype="http://schema.org/CreativeWork" id="post-3721">
          <header class="entry-header">
            <h4 class="entry-title no-anchor" itemprop="headline">
              <iron-icon class="iron-icon" icon="vaadin:check-circle"></iron-icon>
              <a href="https://conversionxli.warmpress.com/lesson/9-friction-imaginary-friction-cognitive-fluency/" rel="bookmark" itemprop="url"><span data-post-status="publish"></span>Friction: Imaginary Friction &amp; Cognitive Fluency</a></h4>        </header><!-- .entry-header -->
        </article><!-- .entry -->


        <article class="entry author-susie post-3723 lesson type-lesson status-publish post course membership-content access-granted " itemscope="itemscope" itemtype="http://schema.org/CreativeWork" id="post-3723">
          <header class="entry-header">
            <h4 class="entry-title no-anchor" itemprop="headline">
              <iron-icon class="iron-icon" icon="lumo:angle-right"></iron-icon>
              <a href="https://conversionxli.warmpress.com/lesson/10-build-slide/" rel="bookmark" itemprop="url"><span data-post-status="publish"></span>Build Your Slide</a></h4>        </header><!-- .entry-header -->
        </article><!-- .entry -->

        <p class="course-progress-navigation">
          <vaadin-button theme="contrast" onclick="window.location.href='https://conversionxli.warmpress.com/lesson/persuasion-slide-introduction/'" tabindex="0" role="button">Prev<iron-icon slot="prefix" icon="lumo:arrow-left"></iron-icon></vaadin-button>
          <vaadin-button theme="secondary" onclick="window.location.href='https://conversionxli.warmpress.com/lesson/3-persuasion-slide/'" tabindex="0" role="button">Next<iron-icon slot="suffix" icon="lumo:arrow-right"></iron-icon></vaadin-button>
        </p>
      </section>
...
CXLAppLayout.storyName = '[id=container]';
